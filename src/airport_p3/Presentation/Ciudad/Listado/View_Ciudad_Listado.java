 ...
 * 
 */
public class View_Ciudad_Listado extends javax.swing.JInternalFrame implements Observer{

    /**
     * Creates new form View
     */
    public View_Ciudad_Listado() {
        initComponents();
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        try {
            ...
            Logger.getLogger(View_Ciudad_Listado.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Ciudad_Listado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_Ciudad_Listado().setVisible(true);
            }
        });
    }
    ...
    public void update(Observable o, Object arg) {
        this.tablaPersonas.setModel(new CiudadTableModel(model.getCiudades()));
        this.tablaPersonas.setRowHeight(30);
        this.nombre.setText(model.getFiltro().getNombre());
    }

    Model_Ciudad_Listado model;
    Control_Ciudad_Listado controller;

    public Model_Ciudad_Listado getModel() {
        return model;
    }

    public void setModel(Model_Ciudad_Listado model) {
        this.model = model;
        model.addObserver(this);
    }

    public Control_Ciudad_Listado getController() {
        return controller;
    }

    public void setController(Control_Ciudad_Listado controller) {
